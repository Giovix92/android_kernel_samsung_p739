...
#ifndef NEW_AP_INTERFACE // SecFeature P7_LTE
static int
...
#else /* NEW_AP_INTERFACE */ // SecFeature P7_LTE START
static int 
iwpriv_get_assoc_list(struct net_device *dev,
        struct iw_request_info *info,
        union iwreq_data *p_iwrq,
...
#endif /* NEW_AP_INTERFACE */ // SecFeature P7_LTE END
#endif /* SOFTAP */
...
*/
#ifdef SOFTAP
#ifdef NEW_AP_INTERFACE // SecFeature P7_LTE START
...
#if defined(SOFTAP) //&& !defined(CONFIG_MACH_SAMSUNG_P4LTE) 
...
#endif /* NEW_AP_INTERFACE */ // SecFeature P7_LTE
#endif /* SOFTAP */
...
static const iw_handler wl_iw_priv_handler[] = {
	...
	*/
#if 0//def CONFIG_MACH_SAMSUNG_P4LTE // SecFeature P7_LTE START
        NULL,
...
#endif 	
#ifdef FEATURE_HOTSPOT_MAX_ASSOC // SecFeature P7_LTE START
        NULL,
