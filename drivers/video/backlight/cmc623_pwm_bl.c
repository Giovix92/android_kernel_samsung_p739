...
#define BRIGHTNESS_LEVEL_MID_MAX        232
#define BRIGHTNESS_LEVEL_MID			150
#define BRIGHTNESS_LEVEL_MIN_MID        86
#define BRIGHTNESS_LEVEL_MIN 			60


//#endif
#elif defined(CONFIG_MACH_SAMSUNG_P5) || defined(CONFIG_MACH_SAMSUNG_P5_CTC)
#define CMC623_PWM_MAX_INTENSITY		255
#define CMC623_PWM_DEFAULT_INTENSITY	150
#define MAX_LEVEL			1600
...
#define BRIGHTNESS_LEVEL_MID			150
#define BRIGHTNESS_LEVEL_MIN_MID        86
#define BRIGHTNESS_LEVEL_MIN 			30
...
#define MID_MAX_BACKLIGHT_VALUE     1200
#define MID_BACKLIGHT_VALUE         784
#define MIN_MID_BACKLIGHT_VALUE     110
#define MIN_BACKLIGHT_VALUE         20
...
#else
    if (intensity >= BRIGHTNESS_LEVEL_MID_MAX)
		tune_level = (intensity - BRIGHTNESS_LEVEL_MID_MAX) * (MAX_BACKLIGHT_VALUE-MID_MAX_BACKLIGHT_VALUE) / (BRIGHTNESS_LEVEL_MAX-BRIGHTNESS_LEVEL_MID_MAX) + MID_MAX_BACKLIGHT_VALUE;
	else if (intensity >= BRIGHTNESS_LEVEL_MID)
		tune_level = (intensity - BRIGHTNESS_LEVEL_MID) * (MID_MAX_BACKLIGHT_VALUE-MID_BACKLIGHT_VALUE) / (BRIGHTNESS_LEVEL_MID_MAX-BRIGHTNESS_LEVEL_MID) + MID_BACKLIGHT_VALUE;	
	else if (intensity >= BRIGHTNESS_LEVEL_MIN_MID)
		tune_level = (intensity - BRIGHTNESS_LEVEL_MIN_MID) * (MID_BACKLIGHT_VALUE-MIN_MID_BACKLIGHT_VALUE) / (BRIGHTNESS_LEVEL_MID-BRIGHTNESS_LEVEL_MIN_MID) + MIN_MID_BACKLIGHT_VALUE;	
	else if (intensity >= BRIGHTNESS_LEVEL_MIN)
		tune_level = (intensity - BRIGHTNESS_LEVEL_MIN) * (MIN_MID_BACKLIGHT_VALUE-MIN_BACKLIGHT_VALUE) / (BRIGHTNESS_LEVEL_MIN_MID-BRIGHTNESS_LEVEL_MIN) + MIN_BACKLIGHT_VALUE;	
	else
		tune_level = DIM_BACKLIGHT_VALUE;
