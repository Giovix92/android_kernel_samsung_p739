...
static void p3_cable_charging(struct battery_data *battery);
#endif
...
#if defined (CONFIG_MACH_SAMSUNG_P5_CTC)
		(fg_vfsoc>70 && (fg_current>20 && fg_current<280) &&
		(avg_current>20 && avg_current<290))) {
#else
