...
void fg_fullcharged_compensation(u32 is_recharging, u32 pre_update)
{
	...
	/*+ Block re-write full_charged_cap to FullCAP, RemCAP_REP for F/G Dis-charging test -*/
#if !defined (CONFIG_MACH_SAMSUNG_P5_CTC)
...
/* tune CGAIN parameter to adjust current */
#if defined(CONFIG_MACH_SAMSUNG_P5_CTC)
	/* CGAIN setting */
	fg_write_register(CGAIN_REG, 0x3048);
#endif
