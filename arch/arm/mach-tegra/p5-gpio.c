...
/*	{NO,	GPIO_TOUCH_RST, 		GPIO_OUTPUT,	GPIO_LEVEL_LOW, 		GPIO_HWREV_NONE  }, */
	...
	{NO,	GPIO_MHL_INT,			GPIO_INPUT,	GPIO_LEVEL_LOW, 		GPIO_HWREV_NONE  },
	...
	{YES,	GPIO_CODEC_I2C_SCL,		GPIO_INPUT,	GPIO_LEVEL_LOW,	GPIO_HWREV_NONE  },	//NC
...
/*	{NO,	GPIO_ADC_INT,			GPIO_OUTPUT,	GPIO_LEVEL_LOW, 		GPIO_HWREV_NONE  }, */
...
#ifdef CONFIG_MACH_SAMSUNG_P5_CTC
    	{YES,	GPIO_ACC_EN,			GPIO_OUTPUT,	GPIO_LEVEL_LOW, 		GPIO_HWREV_06 },
	{YES,	GPIO_CP_DUMP_INT,		GPIO_INPUT,	GPIO_LEVEL_LOW, 		GPIO_HWREV_NONE },
	{YES,	GPIO_TOUCH_ID,		GPIO_INPUT,	GPIO_LEVEL_NONE, 		GPIO_HWREV_NONE },	
#else
	...
	{YES,	GPIO_GPS_UART_TXD,		GPIO_OUTPUT,	GPIO_LEVEL_LOW,		GPIO_HWREV_NONE },	//NC
	{YES,	GPIO_GPS_UART_RXD,		GPIO_OUTPUT,	GPIO_LEVEL_LOW,		GPIO_HWREV_NONE },	//NC
	{YES,	GPIO_GPS_UART_CTS,		GPIO_OUTPUT,	GPIO_LEVEL_LOW,		GPIO_HWREV_NONE },	//NC
	{YES,	GPIO_GPS_UART_RTS,		GPIO_OUTPUT,	GPIO_LEVEL_LOW,		GPIO_HWREV_NONE },	//NC
...
/*	{NO,	GPIO_HW_REV0,			GPIO_OUTPUT,	GPIO_LEVEL_LOW, 		GPIO_HWREV_NONE  }, 	*/
	...
	{YES,	TEGRA_GPIO_PA6,			GPIO_INPUT,	GPIO_LEVEL_LOW,	GPIO_HWREV_NONE },	//NC
	{YES,	TEGRA_GPIO_PA7,			GPIO_OUTPUT,	GPIO_LEVEL_LOW,	GPIO_HWREV_NONE },	//NC
	{YES,	TEGRA_GPIO_PB7,			GPIO_OUTPUT,	GPIO_LEVEL_LOW,	GPIO_HWREV_NONE },	//NC		
	{YES,	TEGRA_GPIO_PB4,			GPIO_OUTPUT,	GPIO_LEVEL_LOW,	GPIO_HWREV_NONE },	//NC	
	{YES,	TEGRA_GPIO_PD1, 			GPIO_INPUT, 	GPIO_LEVEL_LOW, 	GPIO_HWREV_NONE },	//NC
	{YES,	TEGRA_GPIO_PD3, 			GPIO_INPUT, 	GPIO_LEVEL_LOW, 	GPIO_HWREV_NONE },	//NC
	{YES,	TEGRA_GPIO_PD4, 			GPIO_INPUT, 	GPIO_LEVEL_LOW, 	GPIO_HWREV_NONE },	//NC
	{YES,	TEGRA_GPIO_PI4,			GPIO_INPUT,	GPIO_LEVEL_LOW,	GPIO_HWREV_NONE  },	//NC
	...
	{YES,	GPIO_HSIC_SUS_REQ,		GPIO_OUTPUT,	GPIO_LEVEL_LOW, 		GPIO_HWREV_NONE },
	...
	{YES,	GPIO_CP_ON, 		GPIO_OUTPUT,	GPIO_LEVEL_NONE, GPIO_HWREV_NONE  },
	//{YES,	GPIO_CP_RST,			GPIO_OUTPUT,	GPIO_CP_ON_PIN_GROUP_SLP_LEVEL, GPIO_HWREV_NONE },
	{YES,	GPIO_CP_RST,			GPIO_OUTPUT,	GPIO_LEVEL_HIGH, GPIO_HWREV_NONE },
	...
	{YES,	GPIO_HSIC_EN,			GPIO_OUTPUT,	GPIO_LEVEL_LOW, 		GPIO_HWREV_NONE  },
	{NO,	GPIO_HSIC_SUS_REQ,		GPIO_INPUT,	GPIO_LEVEL_LOW, 		GPIO_HWREV_NONE },	//NC
	{NO,	GPIO_HSIC_ACTIVE_STATE,		GPIO_OUTPUT,	GPIO_LEVEL_LOW, 		GPIO_HWREV_NONE  },
	{YES,	GPIO_IPC_HOST_WAKEUP,		GPIO_INPUT,	GPIO_LEVEL_LOW,		GPIO_HWREV_NONE  },	//NC
...
static struct sec_gpio_cfg_st p3_gpio_table_rev04[] = {
	...
	{GPIO,	TEGRA_GPIO_PI4,		GPIO_OUTPUT,	GPIO_LEVEL_NONE,	GPIO_HWREV_NONE },	//NC /* GPIO_MLCD_ON */
};
...
/*	{GPIO,	GPIO_TOUCH_RST, 		GPIO_OUTPUT,	GPIO_LEVEL_NONE,	GPIO_HWREV_NONE },	*/
	...
	{GPIO,	GPIO_CODEC_I2C_SCL,		GPIO_INPUT,	GPIO_LEVEL_LOW,	GPIO_HWREV_NONE },	//NC
...
#ifdef CONFIG_MACH_SAMSUNG_P5_CTC
    	{GPIO,	GPIO_ACC_EN,			GPIO_OUTPUT,	GPIO_LEVEL_HIGH,	GPIO_HWREV_06},
	{GPIO,	GPIO_CP_DUMP_INT,		GPIO_INPUT,	GPIO_LEVEL_LOW, 	GPIO_HWREV_NONE },
	{GPIO,	GPIO_TOUCH_ID,		GPIO_INPUT,	GPIO_LEVEL_NONE, 	GPIO_HWREV_NONE },	
#else
...
/*	{GPIO,	GPIO_ACC_INT,			GPIO_INPUT, GPIO_LEVEL_NONE,	GPIO_HWREV_NONE }, */
	...
	{GPIO,	GPIO_GPS_UART_TXD,		GPIO_OUTPUT,	GPIO_LEVEL_LOW,	GPIO_HWREV_NONE },	//NC
	{GPIO,	GPIO_GPS_UART_RXD,		GPIO_OUTPUT,	GPIO_LEVEL_LOW,	GPIO_HWREV_NONE },	//NC
	{GPIO,	GPIO_GPS_UART_CTS,		GPIO_OUTPUT,	GPIO_LEVEL_LOW,	GPIO_HWREV_NONE },	//NC
	{GPIO,	GPIO_GPS_UART_RTS,		GPIO_OUTPUT,	GPIO_LEVEL_LOW,	GPIO_HWREV_NONE },	//NC
...
//	{GPIO,	TEGRA_GPIO_PH2,			GPIO_OUTPUT,	GPIO_LEVEL_LOW,		GPIO_HWREV_NONE },
	...
	{GPIO,	TEGRA_GPIO_PD1,			GPIO_INPUT,	GPIO_LEVEL_LOW,	GPIO_HWREV_NONE },	//NC
	{GPIO,	TEGRA_GPIO_PD3,			GPIO_INPUT,	GPIO_LEVEL_LOW,	GPIO_HWREV_NONE },	//NC
	{GPIO,	TEGRA_GPIO_PD4,			GPIO_INPUT,	GPIO_LEVEL_LOW,	GPIO_HWREV_NONE },	//NC
	...
	{GPIO,	TEGRA_GPIO_PA6,			GPIO_INPUT,	GPIO_LEVEL_LOW,	GPIO_HWREV_NONE },	//NC
	{GPIO,	TEGRA_GPIO_PA7,			GPIO_OUTPUT,	GPIO_LEVEL_LOW,	GPIO_HWREV_NONE },	//NC
	{GPIO,	TEGRA_GPIO_PB7,			GPIO_OUTPUT,	GPIO_LEVEL_LOW,	GPIO_HWREV_NONE },	//NC
	{GPIO,	TEGRA_GPIO_PB4,			GPIO_OUTPUT,	GPIO_LEVEL_LOW,	GPIO_HWREV_NONE },	//NC
	{GPIO,	TEGRA_GPIO_PK4,			GPIO_OUTPUT,	GPIO_LEVEL_LOW,	GPIO_HWREV_NONE },
	{GPIO,	TEGRA_GPIO_PI4,			GPIO_OUTPUT,	GPIO_LEVEL_LOW,	GPIO_HWREV_06  },	//NC
	...
	{GPIO,	GPIO_HSIC_SUS_REQ,		GPIO_OUTPUT,	GPIO_LEVEL_LOW,	GPIO_HWREV_NONE },
...
#else	
	{GPIO,	GPIO_CP_ON,			GPIO_OUTPUT,	GPIO_INIT_LEVEL_IPC_BACK_POWERING,	GPIO_HWREV_NONE },//jaeho21.song	
  //{GPIO,	GPIO_CP_RST,			GPIO_OUTPUT,	GPIO_INIT_LEVEL_IPC_BACK_POWERING,	GPIO_HWREV_NONE },
	{GPIO,	GPIO_CP_RST,			GPIO_OUTPUT,	GPIO_LEVEL_HIGH,	GPIO_HWREV_NONE },
	{GPIO,	GPIO_RESET_REQ_N,		GPIO_INPUT,	GPIO_LEVEL_LOW,	GPIO_HWREV_NONE },	//NC
	...
	{GPIO,	GPIO_HSIC_EN,			GPIO_OUTPUT,	GPIO_LEVEL_LOW,	GPIO_HWREV_NONE },	//NC
	{GPIO,	GPIO_HSIC_SUS_REQ,		GPIO_INPUT,	GPIO_LEVEL_LOW,	GPIO_HWREV_NONE },	//NC
	{GPIO,	GPIO_HSIC_ACTIVE_STATE,		GPIO_OUTPUT,	GPIO_INIT_LEVEL_IPC_BACK_POWERING,	GPIO_HWREV_NONE },
	{GPIO,	GPIO_IPC_HOST_WAKEUP,		GPIO_INPUT,	GPIO_LEVEL_LOW,	GPIO_HWREV_NONE },	//NC
