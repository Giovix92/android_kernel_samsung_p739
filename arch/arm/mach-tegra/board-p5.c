...
// 		//.multi_conf_functions[1] = usb_functions_mtp_acm,	
		//.multi_conf_functions[2] = usb_functions_mtp_acm_adb,
	},
	{
		.product_id	= SAMSUNG_KIES_PRODUCT_ID,
...
#elif defined (CONFIG_MACH_SAMSUNG_P5_CTC)
	.temp_high_threshold = 60000,	/* 60c */
	.temp_high_recovery = 45000,	/* 43.5c */
	.temp_low_recovery = 2000,		/* 1.5c */
	.temp_low_threshold = -2000,	/* -4c */
	.charge_duration = 10*60*60,	/* 10 hour */
...
// CONFIG_MACH_S5PC110_ARIESCT
struct platform_device sec_device_dpram_cdma = {
	.name	= "dpram0-cdma",
	.id		= -1,
};
...
static struct platform_device *p3_devices[] __initdata = {
	...
	&s3c_device_usb_mass_storage, //add by chengguipeng
#endif
	...
	&tegra_das_device,
	&ram_console_device,
	&sec_device_dpram_cdma,
#ifdef CONFIG_SAMSUNG_PHONE_TTY_MODULE
	&sec_device_dpram,
#endif
#if defined(CONFIG_TDMB) || defined(CONFIG_TDMB_MODULE)
	&tegra_spi_device1,
